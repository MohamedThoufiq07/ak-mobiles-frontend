...
const Layout = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden animated-gradient-bg">
      {/* Background Orbs — kept STATIC. They were animating infinitely with
          blur(100px)+mix-blend-screen on viewport-sized elements, which pegged
          the GPU every frame and caused site-wide scroll/interaction lag. */}
